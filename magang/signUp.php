...
if ($result) {
  ...
  if ($userStat == "Member") {
    $sql2 = "INSERT INTO `userpass` (`UserId`, `NamaLengkap`, `Password`, `Status`, `LastLogin`) 
    VALUES ('$insertedUserId', '$username', '$password', '3', '$createdDate')";
    ...
    $response = ['success' => true, 'data' => $insertedUserId];
  }
} else {
