...
// $uname = "cs";
$uname = $_POST['uname'] ?? '';
$sql = "SELECT DISTINCT chat.CustId, chat.IdCabRep
FROM chat
INNER JOIN customercare cc ON chat.IdCabRep = cc.IdCabRep
...
if ($result) {
    ...
    $response = ['success' => false, 'message' => 'No cs chat list data found'];
}
